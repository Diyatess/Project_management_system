...
{
    $token=$_GET['token'];
    $verify_query = "SELECT verify_token,verify_status FROM employee WHERE verify_token='$token' LIMIT 1 ";
    ...
    if(mysqli_num_rows($verify_query_run)>0)
    {
        ...
        if($row['verify_status']== "0")
        {
                ...
                $update_query = "UPDATE employee SET verify_status='1' WHERE verify_token='$clicked_token' LIMIT 1 ";
