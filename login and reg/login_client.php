...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_client = "SELECT * FROM client WHERE username='$username' AND password='$hashed_password'";
    ...
    echo "Invalid username or password. <a href='client_login.html'>Go back</a>";
}
...
<body>
    ...
    <form method="post">
       ...
       <label for="username">Username</label>
        <input type="text" placeholder="Enter Username" id="username" name="username" autocomplete="off">
        ...
        <a href="register_client.php" >Create a account</a><br><br>
